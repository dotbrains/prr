...
export function HeroSection({ onLearnMore }: HeroSectionProps) {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-prr-amber/10 via-dark-slate to-dark-slate">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-prr-orange/20 via-transparent to-transparent"></div>
      </div>

      {/* Hero Content */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 pt-24 sm:pt-32 lg:pt-40 pb-16 sm:pb-24 lg:pb-32">
        <div className="text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-prr-amber/10 border border-prr-amber/20 rounded-full mb-4 sm:mb-6">
            <Github className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-prr-amber" />
            <span className="text-xs sm:text-sm text-prr-amber font-medium">Open Source • PolyForm Shield 1.0.0</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
            <a
              href="/#quick-start"
              className="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-prr-amber to-prr-orange hover:from-prr-orange hover:to-prr-gold text-white px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold rounded-lg shadow-lg shadow-prr-amber/30 transition-all"
            >
        ...
        <div className="mt-12 sm:mt-16 md:mt-24 grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 md:gap-8 max-w-5xl mx-auto px-4">
          <div className="bg-dark-gray/50 backdrop-blur-sm border border-prr-amber/30 rounded-xl p-4 sm:p-6 text-center">
          ...
          <div className="bg-dark-gray/50 backdrop-blur-sm border border-prr-orange/30 rounded-xl p-4 sm:p-6 text-center">
            <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-gradient mb-2">
              Human
            </div>
            <div className="text-cream/60 text-sm sm:text-base md:text-lg">Like Comments</div>
          </div>
          <div className="bg-dark-gray/50 backdrop-blur-sm border border-prr-gold/30 rounded-xl p-4 sm:p-6 text-center">
            <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-gradient mb-2">
              Go
            </div>
